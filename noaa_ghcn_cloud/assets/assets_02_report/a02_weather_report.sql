  ...
  - name: weather_symbol
    ...
    checks:
      - name: accepted_values
        value: ['❄️🌨️ Heavy snow', '🌨️ Moderate snow', '⛄ Snow on ground', '⛈️ Heavy rain', '🌧️ Moderate rain', '🌦️ Light rain', '☀️🌡️ Hot', '☀️ Sunny', '🌤️ Cold and clear', '🥶 Below freezing', '❓ Unclassified']
  - name: climate_code
    type: int
